...
./autogen.sh
./configure ac_cv_lib_crypto_OpenSSL_add_all_ciphers=yes --prefix=/usr CFLAGS="-g -O2 -Wno-error -Wno-implicit-function-declaration"
make CFLAGS="-g -O2 -Wno-error -Wno-implicit-function-declaration"
$SUDO make install
cd ../..
